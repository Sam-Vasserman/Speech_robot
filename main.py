...
import random
import requests
from Include.dict import sites, apps, dictionary, greetings
...
def makeSomething(task):
    ...
    if task in dictionary:
        ...
        talk("С какого языка на какой перевести? Скажи 1 если с английского на русский, 2 если с русского на английский, 3 если с иврита на русский, 4 если с русского на иврит, 5 если с иврита на английский, 6 если с английского на иврит")
        number = command()
        talk('напиши, что я могу перевести для тебя')
        word = input()
        translators(word, number)
    else:
